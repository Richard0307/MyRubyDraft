...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label', class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :vertical_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label', class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'label', class: 'col-form-label pt-0 d-block' do |ba|
      ba.use :label_text
  ...
  config.wrappers :custom_collection, item_wrapper_class: 'custom-control', item_label_class: 'custom-control-label', class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'label', class: 'col-form-label pt-0 d-block' do |ba|
      ba.use :label_text
  ...
  config.wrappers :custom_collection_inline, item_wrapper_class: 'custom-control custom-control-inline', item_label_class: 'custom-control-label', class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'label', class: 'col-form-label pt-0 d-block' do |ba|
      ba.use :label_text
